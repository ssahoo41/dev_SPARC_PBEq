...
\begin{block}{Description}
Flag to select to solve a standard subspace eigenvalue problem or a generalized subspace eigenvalue problem (whether to orthogonalize the orbitals before the Rayleigh-Ritz procedure).
\end{block}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[allowframebreaks]{\texttt{CS\_FLAG}} \label{CS_FLAG}
\vspace*{-12pt}
\begin{columns}
\column{0.4\linewidth}
\begin{block}{Type}
...
\begin{block}{Example}
\texttt{CS\_FLAG}: \texttt{1}
\end{block}
\end{columns}

\begin{block}{Description}
The complementary subspace method is used if this flag is set to $1$.
\end{block}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[allowframebreaks]{\texttt{CS\_NSTATES\_TOP}} \label{CS_NSTATES_TOP}
\vspace*{-12pt}
\begin{columns}
\column{0.4\linewidth}
\begin{block}{Type}
...
\begin{block}{Example}
\texttt{CS\_NSTATES\_TOP}: \texttt{10}
\end{block}
\end{columns}

\begin{block}{Description}
The number of top states that are partially occupied considered in the complementary subspace method.
\end{block}

\begin{block}{Remark}
This is used only when \hyperlink{CS_FLAG}{\texttt{CS\_FLAG}} is turned on.
\end{block}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[allowframebreaks]{\texttt{CS\_CHEBDEGREE}} \label{CS_CHEBDEGREE}
\vspace*{-12pt}
\begin{columns}
\column{0.4\linewidth}
\begin{block}{Type}
...
\begin{block}{Example}
\texttt{CS\_CHEBDEGREE}: \texttt{10}
\end{block}
\end{columns}

\begin{block}{Description}
Degree of polynomial used for Chebyshev filtering on the subspace Hamiltonian.
\end{block}

\begin{block}{Remark}
The spectrum width of the subspace Hamiltonian is very small, therefore the degree of polynomial required is usually very small. If this value is too large, the eigenvectors might become linearly dependent and causes the $2$nd level CheFSI to fail. In such cases, set the degree to a smaller value, and repeat the Chebyshev filtering multiple times by setting \hyperlink{CS_NCHEB}{\texttt{CS\_NCHEB}}. \\
This is used only when \hyperlink{CS_FLAG}{\texttt{CS\_FLAG}} is turned on.
\end{block}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[allowframebreaks]{\texttt{CS\_NCHEB}} \label{CS_NCHEB}
\vspace*{-12pt}
\begin{columns}
\column{0.4\linewidth}
\begin{block}{Type}
...
\begin{block}{Example}
\texttt{CS\_NCHEB}: \texttt{2}
\end{block}
\end{columns}

\begin{block}{Description}
Number of Chebyshev filtering applied on the subspace Hamiltonian in the $2$nd level CheFSI.
\end{block}
...
\begin{block}{Default}
Automatically set for $10^{-3}$ Ha/Bohr accuracy in energy and force
\end{block}
...
\begin{block}{Remark}
Only active when using hybrid functionals, like PBE0 and HSE. \texttt{FOURIER\_SPACE} method is much faster than \texttt{REAL\_SPACE} method.
\end{block}
